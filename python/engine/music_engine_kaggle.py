...
class MusicEngine:
    def __init__(self):
# -------------------------------------
# OLD WORKING CODE (VLC INITIALIZATION)
# -------------------------------------
...
# -------------------------------------
        try:
            ...
            print(f"⚠️ [MusicEngine] VLC initialization failed (headless/no VLC installation?): {e}")
            self.instance = None
            self.player = None
        ...
        try:
            ...
            print(f"⚠️ [MusicEngine] YTMusic initialization failed: {e}")
            self.ytmusic = None
    ...
    def play(self, song_name):
        ...
        if not self.player:
            print(f"🎵 [MusicEngine Bypass] Mock playing song: '{song_name}' (VLC not available)")
            self.is_playing = True
            return

        if not self.ytmusic:
            print("YTMusic API not initialized.")
            return
